...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ruixiaoguo/passWordView.git"
  ...
  s.source       = { :git => "https://github.com/ruixiaoguo/passWordView.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "验证码输入框/passWordView/*.{h,m}"
  s.exclude_files = ""
